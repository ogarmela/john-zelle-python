...
def main8():
    choice = input("Would you like to encode or decode a message (Enter encode/decode): ")
    if choice[0] == "e" or choice[0] == "E":
        ...
        for ch in message:
            ...
            new = chr(new)
            encode = encode + new
        print("The encoded message is: '{0}'".format(encode))
        ...
        for ch in message:
            ...
            new = chr(new)
            decode = decode + new
        print("The decoded message is: '{0}'".format(decode))
    else:
